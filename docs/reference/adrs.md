...
Architecture Decision Records for CONCERTO + CHAMBER.
The canonical snapshot lives in the [`adr/`](https://github.com/concerto-org/concerto/tree/main/adr)
directory of this repository.

| ADR | Title | Status |
|-----|-------|--------|
| ADR-001 | Fork vs. build above ManiSkill v3 | Accepted |
| ADR-002 | RL framework and training algorithm | Accepted |
| ADR-003 | Communication interface | Accepted |
...
| ADR-011 | Baseline algorithm set | Accepted |
| ADR-012 | Licence and contributor agreement | Accepted |
