...
EXPLORATORY only, quarantined under the ``chamber.partners.exploratory``
namespace (ADR-027 §Reporting rules: structurally ineligible for
leaderboard-facing runs; the prior import path
``chamber.partners.static_override`` survives as a deprecation
re-export). Activated solely via
