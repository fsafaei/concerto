...
- Pre-registration: tag `prereg-admission-cocarry-a4-rev2-2026-07-15`, blob `302b769902c14b6f77c54ece4d0c9eefcdb2e061`
- Launch commit: `04c407efa37206f27dcc346ff4fe9d58f45681a5`
...
- `c_min_ego` = 0.75 (A4 ego-robustness floor, per-partner CI lower bound)
...
Criterion: per admitted partner: success_ci_low >= c_min_ego (0.75) with successful-episode stress peak <= stress_limit (130.56970529556276); any partner with success_ci_high < c_min_ego is brittle -> UNINSTRUMENTABLE (ADR-026 §Decision 2: a construct problem, not a partner/axis result)
