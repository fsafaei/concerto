...
emits the machine-readable form); CI fails if it drifts.
...
| `cocarry@v1` — Co-carry — rigid dual-arm bar transport | 2 (admitted cooperation tasks) | CANDIDATE | AS `null` | [cocarry](docs/reference/tasks/cocarry.md) |
| `handover_place@v1` — Handover-and-place under takt pressure | 2 (admitted cooperation tasks) | CANDIDATE | all untested | [handover_place](docs/reference/tasks/handover_place.md) |
